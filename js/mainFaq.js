    ...
    Alpine.data("faq", () => ({
        data: [
            ...
            },
            {
                ...
                answer: '네비게이션에서 "누아주 가든"을 찍어서 오시면 됩니다. 오시는 길에 안내표지판 및 안내원이 배치되어 있습니다.',
            },
            {
                category: '🚌 셔틀버스',
            ...
            },
            {
                ...
                answer: '네. 천막이 설치되어 우천여부 상관없이 예식이 진행됩니다.',
            },
            {
                category: '🥣 식사',
                question: '점심식사는 언제 제공되나요?',
                answer: '1부(약 12:30분 종료)이후 앉은 자리에서 뷔폐로 진행되고 2부가 시작되어도 야외 및 실내 테이블에서 지속적으로 드실 수 있습니다.',
            },
        ],
        faqOpens: [],
        init() {
